...
namespace Assingnment_Classes_Object
{
    internal class Q5
    {
        ...
        public Q5(int serialno ,string name,string title,string author,int booksQt,int bookprice,int bill)
        {
        ...
        {
            List<Q5> booksdetails = new List<Q5>();
            int choice = 0;
